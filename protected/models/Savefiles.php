 ...
 */
class Savefiles extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('FilesID, UserID', 'length', 'max'=>11),
			array('Name, Savetext', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, FilesID, Name, UserID, Savetext', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'files' => array(self::BELONGS_TO, 'Files', 'FilesID'),
	...
	public function search()
	{
		...
		$criteria->compare('Savetext',$this->Savetext,true);
